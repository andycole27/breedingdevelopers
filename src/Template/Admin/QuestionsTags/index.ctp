 ...
 * @var \App\Model\Entity\QuestionsTag[]|\Cake\Collection\CollectionInterface $questionsTags
 */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $questionsTag->has('tag') ? $this->Html->link($questionsTag->tag->id, ['controller' => 'Tags', 'action' => 'view', $questionsTag->tag->id]) : '' ?></td>
                <td class="actions">
